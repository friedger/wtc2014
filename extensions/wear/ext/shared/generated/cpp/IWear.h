...
struct IWearSingleton
{
//constants


    virtual ~IWearSingleton(){}
...
struct IWearFactory
{
    virtual ~IWearFactory(){}

    virtual IWearSingleton* getModuleSingleton() = 0;


    virtual IWear* getModuleByID(const rho::String& strID) = 0;
